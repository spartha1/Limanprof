...
<body>
    <header class="header">
        ...
        <nav class="menu">
            <a href="/Limanprof/public/index.php" style="--i:0;">Inicio</a>
    ...
    <main>
        <section class="home" id="home">
            <div class="home-content">
                ...
                <p>
                    En Limanprofnprof ofrecemos serivios de limpieza, jardineria, mantenimiento y otros servicios mas especificos a
