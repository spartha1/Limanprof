...
<body>
    ...
    <section class="home" id="home">
            <div class="home-content">
                <h1><span>JARDINERIA</span></h1>
                <div class="text-animate">
                </div>
                <p>
                Es un servicio de mantenimiento que tiene como objetivo el cuidado de las zonas verdes de un espacio. Mejorando la calidad del aire o moderación de temperaturas. 
                Mejorando el bienestar de los usuarios. 
                Es un protocolo de mantenimiento de un espacio.
            </div>
            <div class="home-image">
                <img src="/Limanprof/public/img/servicios/Sellado-de-macetas.webp" alt="Limanprofnprof" width="500" height="600">
            </div>
