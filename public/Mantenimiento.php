    ...
    <main>
        ...
        <div class="contenedor">
            <div class="cuadro">
                ...
                <p class="descripcion">
                    El mantenimiento en condominios es fundamental para mantener un buen funcionamiento de todas las instalaciones.
                    Ofrecemos un servicio de limpieza con personal capacitad.
                    Es valioso tanto para los propietarios de un inmueble como para quienes lo ocupan, se enfoca en todas las necesidades de condominio.
                    Buscamos perseverar un área para proveer condiciones optimas de la residencia.
                </p>
            </div>
            ...
            <div class="imagen">
                <img src="/lima/public/img/mantenimiento.webp" alt="limpieza" width="600" height="500">
            </div>
        </div>
    </main>
    <footer>
