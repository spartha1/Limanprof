...
<body>
    <header class="header">
        <a href="#"><img class="logo" src="/public/img/logoLimanproffSB.png" alt="Logo de Limanprofnprof"></a>
    ...
    <section class="home" id="home">
            ...
            <div class="home-image">
                <img src="/public/img/servicios/limp-estacionamiento.webp" alt="Limanprofnprof" width="500" height="600">
            </div>
